...
PG_KEYWORD("extmerge", EXTMERGE, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("extmergef", EXTMERGEF, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("tm", TM, UNRESERVED_KEYWORD, BARE_LABEL)
