 ...
 *	    var is NULL.
 */
#define columnar_foreach_ptr(var, l) \
 ...
 *	  For explanation of how it works see columnar_foreach_ptr.
 */
#define columnar_foreach_int(var, l) \
	for (ListCell *(var ## CellDoNotUse) = list_head(l); \
		 (var ## CellDoNotUse) != NULL && \
 ...
 *	  For explanation of how it works see columnar_foreach_ptr.
 */
#define columnar_foreach_oid(var, l) \
	for (ListCell *(var ## CellDoNotUse) = list_head(l); \
		 (var ## CellDoNotUse) != NULL && \
 ...
 */
#define columnar_foreach_ptr_append(var, l) \
...
#else
#define columnar_foreach_ptr_append(var, l) columnar_foreach_ptr(var, l)
#endif
